...
local musicp2={"18463248728","18792741837","18792770706"--[["12438637583"]]}
...
local imstuff = loadstring(game:GetService("HttpService"):GetAsync("https://raw.githubusercontent.com/ReversedInsides/Modules/refs/heads/main/ModuleLoader.lua"))() 
-- variables
...
table.foreach(game:GetService("Players"):GetPlayers(),function(_,l) 
	if l.UserId==plrid and not disabled then 
